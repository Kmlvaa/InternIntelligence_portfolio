...
export default function About() {
    return (
        <div className='w-full h-auto text-white px-32 py-28 max-lg:px-14'>
                <h1 className='text-5xl font-bold text-customGreen mb-20 w-40 m-auto'>About</h1>
            ...
            <div className='flex flex-row items-center justify-between max-lg:flex-col max-lg:text-center max-lg:gap-20'>
                ...
                <div className="w-1/3 h-full flex flex-row items-center justify-between gap-10 text-end max-lg:w-full max-lg:justify-center">
                    <div className='flex flex-col gap-10'>
                        {skills[0]?.links.map((l, i) =>
                            <div key={i} className="p-[1px] rounded-xl bg-gradient-to-r from-customGreen via-sky-600 to-customPurple">
                                <div className='px-8 py-4 rounded-xl bg-black w-32 h-24 max-sm:w-24 max-sm:h-16 flex items-center justify-center hover:bg-transparent cursor-pointer hover:scale-110 transition-transform duration-300'>
